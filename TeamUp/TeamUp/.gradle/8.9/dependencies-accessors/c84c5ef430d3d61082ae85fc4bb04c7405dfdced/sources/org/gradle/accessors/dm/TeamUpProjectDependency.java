...
@NonNullApi
public class TeamUpProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TeamUpProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
